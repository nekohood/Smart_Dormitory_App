...
class Document {
  ...
  final String status; // 대기, 검토중, 승인, 반려
  ...
  @override
  String toString() {
    return 'Document{id: $id, title: $title, writerId: $writerId, status: $status, dormitoryBuilding: $dormitoryBuilding, roomNumber: $roomNumber}';
  }
