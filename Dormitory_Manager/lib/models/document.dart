...
class Document {
  ...
  String? get imageUrl {
    if (imagePath == null || imagePath!.isEmpty) {
      print('[DEBUG] Document imageUrl: imagePath is null or empty');
      return null;
    }
    ...
    print('[DEBUG] Document imageUrl: imagePath=$imagePath, fullUrl=$fullUrl');
  ...
  @override
  String toString() {
    return 'Document{id: $id, title: $title, status: $status, imagePath: $imagePath}';
  }
