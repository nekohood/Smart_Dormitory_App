...
class _DocumentSubmitScreenState extends State<DocumentSubmitScreen> {
  ...
  void initState() {
    super.initState();
    final categories = DocumentRepository.getDocumentCategories();
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('서류가 성공적으로 제출되었습니다.'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: DocumentRepository.getDocumentCategories()
